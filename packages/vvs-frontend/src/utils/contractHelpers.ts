...
export const getVvsContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(vvsAbi, tokens.vvs.address, signer)
}
...
export const getVvsVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(vvsVaultAbi, getVvsVaultAddress(), signer)
}
