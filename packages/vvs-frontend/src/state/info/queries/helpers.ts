import { ONE_DAY_UNIX, VVS_FINANCE_START } from 'config/constants/info'
import { getUnixTime } from 'date-fns'
import { TransactionType } from 'state/info/types'
import { ChartEntry } from '../types'
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, VvsDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | VvsDayData): ChartEntry => ({
