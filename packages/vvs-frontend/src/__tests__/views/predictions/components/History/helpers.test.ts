...
import { formatCro, formatUsd, getMultiplier, getPayout } from 'views/Predictions/components/History/helpers'
...
describe('formatBnb', () => {
  it.each([
    ...
    expect(formatCro(value)).toEqual(expected)
  })

  it('returns 0 if BNB is undefined', () => {
    expect(formatCro(undefined)).toEqual('0')
  })
})
