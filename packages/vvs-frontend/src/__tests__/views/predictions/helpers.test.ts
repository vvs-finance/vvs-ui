...
import { formatRoundTime, padTime, formatCrov2, formatUsdv2 } from 'views/Predictions/helpers'
...
describe('formatBnbv2', () => {
  ...
  `(
    'should format $priceDifference to $expectedPriceDifferenceFormatted',
    ({ priceDifference, expectedPriceDifferenceFormatted }) =>
      expect(formatCrov2(BigNumber.from(priceDifference))).toEqual(expectedPriceDifferenceFormatted),
  )
})
