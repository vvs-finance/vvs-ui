...
const MIN_PRICE_CRO_DISPLAYED = BigNumber.from('1000000000000000')
...
export const formatCrov2 = (cro: BigNumber) => {
  return formatPriceDifference({ price: cro, minPriceDisplayed: MIN_PRICE_CRO_DISPLAYED, unitPrefix: '', decimals: 18 })
}
