...
export const INFO_CLIENT = process.env.REACT_APP_EXCHANGE_URL
export const BLOCKS_CLIENT = process.env.REACT_APP_BLOCK_URL
export const FARM_CLIENT = process.env.REACT_APP_FARM_URL
