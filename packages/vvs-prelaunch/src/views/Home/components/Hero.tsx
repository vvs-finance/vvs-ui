...
import { Flex, Link, Text, useMatchBreakpoints } from 'vvs-uikit'
    ...
    <>
      ...
      <HeroContainer position="relative" justifyContent="center" id="homepage-hero" minHeight="358px">
        <Flex flex="1" flexDirection="column" maxWidth="512px" mt={["40px", "40px", "40px", "80px"]}>
          ...
          <Text {...titleStyleProps} color="white">
            <Link color="rgb(70, 161, 194)" mr="5px" href="https://medium.com/vvs-finance/vvs-finance-very-very-simple-defi-for-everyone-8c864be68b6a" display="inline-block" {...titleStyleProps}>
              Learn more
            </Link>
            about VVS Finance.
          </Text>
